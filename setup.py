...
def get_cuda_include_dirs(use_conda: bool = True) -> List[str]:
    py_version = f"{sys.version_info.major}.{sys.version_info.minor}"
    return [
        f"{CONDA_PREFIX}/lib/python{py_version}/site-packages/nvidia/{p}/include"
        for p in [
            "cublas",
            "cuda_cupti",
            "cuda_nvrtc",
...
for ext_module in ext_modules:
    ext_module.include_dirs.extend(get_cuda_include_dirs())
...
setuptools.setup(
    ...
    packages=setuptools.find_packages(exclude=("assets", "benchmarks", "csrc",
                                               "docs", "examples", "tests")),
    python_requires=">=3.8",
